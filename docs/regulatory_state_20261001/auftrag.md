<!-- Repo-Notiz (nicht Teil des Auftragstexts): Wortlaut des Claude-Projektdokuments,
     Fassung vom 18.09.2026 (Stand nach O-18), an diesem Tag in die Arbeitssitzung
     übergeben und hier unverändert abgelegt. Ersetzt die Fassung vom 18.09.2026 (Stand nach Etappe 5). Abweichungen zwischen
...
**Kernbefund K-1, für den Übergabebericht in Etappe 8 hervorzuheben:** Über Etappe 0–2 hinweg (36 Dokumente, 209 Fassungen) haben 116 Fassungen keinen Mitteilungsbezug — darunter 11 von 36 maßgeblichen Fassungen. In knapp einem Drittel der Fälle kennt die amtliche BNetzA-Quelle die am Stichtag tatsächlich geltende Fassung nicht; sie wäre ohne den BDEW-Abgleich aus Abschnitt 5 unauffindbar geblieben. **Ergänzung aus Etappe 4, korrigiert 2026-09-18 (O-18):** ein weiterer Fall ohne Mitteilungsbezug ist hinzugekommen — die Standardlastprofile nach TU München 1.1, die in keiner Mitteilung stehen und keine eigene BNetzA-Anlage besitzen. Sie werden über Kriterium C gehalten, allerdings anders als ursprünglich berichtet: Der einzige echte Dokumentverweis findet sich in UTILMD MIG Gas G1.2 (S. 143) und nennt nur den Dokumentnamen (den Titel der Basisfassung), ohne Versionsnummer — nicht, wie zunächst gemeldet, mit Dokumentname und Version. Details und die daraus resultierende Erweiterung von Kriterium C siehe 11e. Die kumulierte Fassungszahl für K-1 wird erst im Etappe-8-Bericht abschließend ausgewertet.
...
Kategorie C aus Abschnitt 4, eigener Block — strukturell anders als EDIFACT-Nachrichtentypen (Transport-/Protokollregelungen statt Nachrichtenformat). Hier werden voraussichtlich die meisten Grenzfälle für die Aufnahmeregel (11e) auftreten, insbesondere bei Redispatch-XML-Dokumenten und API-Webdiensten, die Mitteilung 56 ausdrücklich nicht veröffentlicht hat — sowohl die Kriterium-C-Präzisierung (Dokumentname erforderlich, keine Gattungsnennung) als auch die Erweiterung zu versionslosen, aber eindeutigen Namensverweisen (beide 11e, aus O-18) hier konsequent anwenden.
*Freigegeben (2026-09-18)* nach Klärung von O-18.
